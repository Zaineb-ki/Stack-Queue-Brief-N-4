...
boutton.onclick = function(){
    music.setAttribute('src', 'https://rss.art19.com/episodes/bdfa93bc-b58d-44d7-9376-226f918e8f2f.mp3');
...
boutton1.onclick = function(){
    music.setAttribute('src', 'https://rss.art19.com/episodes/45f42575-c955-41c3-8f46-71ef42897802.mp3');
...
boutton2.onclick = function(){
    music.setAttribute('src', 'https://rss.art19.com/episodes/e76a6bcd-ade8-4c72-bd79-1f781eda32b2.mp3');
    para.style.color = "black";
    para1.style.color = "black";
...
boutton3.onclick = function(){
    music.setAttribute('src', 'https://rss.art19.com/episodes/fade4b87-6f02-4e8c-a466-43a7c51bab95.mp3');
    para.style.color = "black";
    para1.style.color = "black";
    para2.style.color = "black";
