...
boutton.onclick = function(){
    music.setAttribute('src', 'https://www.podtrac.com/pts/redirect.mp3/audio.wnyc.org/radiolab_podcast/radiolab_podcast20theotherlatif1.mp3');
...
boutton1.onclick = function(){
    music.setAttribute('src', 'https://www.podtrac.com/pts/redirect.mp3/audio.wnyc.org/radiolab_podcast/radiolab_podcast20thebobbys.mp3');
...
boutton2.onclick = function(){
    music.setAttribute('src', 'https://www.podtrac.com/pts/redirect.mp3/audio.wnyc.org/radiolab_podcast/radiolab_podcast20bodycount.mp3');
    para.style.color = "black";
    para1.style.color = "black";
...
boutton3.onclick = function(){
    music.setAttribute('src', 'https://www.podtrac.com/pts/redirect.mp3/audio.wnyc.org/radiolab_podcast/radiolab_podcast20_60words.mp3');
    para.style.color = "black";
    para1.style.color = "black";
    para2.style.color = "black";
